...
<div id = "page-blog-author" class = "subpage-wrapper <?php echo ot_get_option('blog_viewtype'); ?>">
						...
						<h2 class = "breadcrumb-title">
							<?php 
								if(is_author()){
									...
									printf(__('<span>Posts by: </span> %s', 'truewordpress'), $author_obj->nickname);
								} else {
									the_title();
								}
							?>
