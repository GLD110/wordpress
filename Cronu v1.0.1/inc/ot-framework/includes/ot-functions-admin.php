					...
					array(
						...
						'pages'	=> array(
							array(
								...
								'page_title'			=> apply_filters( 'ot_theme_options_page_title', __( 'TRUEWorpdress Theme Options', 'option-tree' ) ),
	...
	function ot_register_settings_page() {
		...
		$ot_register_pages_array =	array(
			array(
				'id'				=> 'settings',
				'parent_slug'		=> apply_filters( 'ot_theme_options_parent_slug', 'themes.php' ),
				'page_title'		=> __('Theme Settings', 'option-tree'),
				'menu_title'		=> __('Theme Settings', 'option-tree'),
