...
/**************************************************************
 *
 * Default Category Posts Template
 *
...
<div id = "page-blog-category" class = "subpage-wrapper <?php echo ot_get_option('blog_viewtype'); ?>">
				...
				<div class = "row">
					<div class = "col-lg-12 col-md-12">
						<h2 class = "breadcrumb-title">
							<?php 
								if(is_category()){
									printf(__('<span>Category:</span> %s', 'truewordpress'), single_cat_title('', false));;
								} else {
									the_title();
								}
							?>
