...
/**************************************************************
 *
 * Default archive Posts Template
 *
...
<div id = "page-blog-archive" class = "subpage-wrapper <?php echo ot_get_option('blog_viewtype'); ?>">
					...
					<div class = "col-lg-12 col-md-12">
						<h2 class = "breadcrumb-title">
							<?php 
								if(is_archive()){
									if(is_day()){
										printf(__('<span>Daily:</span> %s', 'truewordpress'), get_the_date());
									} else if(is_month()){
										printf(__('<span>Monthly:</span> %s', 'truewordpress'), get_the_date(_x('F Y', 'monthly archives date format', 'truewordpress')));
									} else if(is_year()){
										printf(__('<span>Yearly:</span> %s', 'truewordpress'), get_the_date(_x('Y', 'yearly archives date format', 'truewordpress')));
									} else {
										printf(__('Blog Archives', 'truewordpress'));
									}
								} else {
									the_title();
								}
