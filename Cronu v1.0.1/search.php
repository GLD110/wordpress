...
/**************************************************************
 *
 * Default search result page Template
 *
...
<div id = "page-blog-search" class = "subpage-wrapper <?php echo ot_get_option('blog_viewtype'); ?>">
						...
						<h2 class = "breadcrumb-title">
							<?php 
								if(is_search()){
									...
									printf(__('<span>Search results for: </span>%s', 'truewordpress'), get_search_query());
								} else {
									the_title();
								}
							?>
