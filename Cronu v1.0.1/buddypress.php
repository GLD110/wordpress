...
/**************************************************************
 *
 * Template Name: Buddypress Page Template
 *
...
<div id = "page-buddypress" class = "subpage-wrapper <?php echo ot_get_option('buddypress_viewtype'); ?>">
	
	<?php if($breadcrumb_section != 'off'): ?>
		<!-- Page title & Breadcrumb - from -->
		<section class = "breadcrumb-wrapper" data-parallax = "scroll" data-image-src = "<?php echo $title_bg[0]? $title_bg[0]: ot_get_option('buddypress_title_bgImage'); ?>">
			<div class = "container">
				<div class = "row">
