...
// current page ID
$pageID = is_home() && get_option('page_for_posts')? get_option('page_for_posts'): get_the_ID();
...
<div id = "page-blog" class = "subpage-wrapper <?php echo ot_get_option('blog_viewtype'); ?>">
				...
				<div class = "row">
					<div class = "col-lg-12 col-md-12">
						<h2 class = "breadcrumb-title">
							<?php echo apply_filters('the_title', get_page($pageID)->post_title); ?>
						</h2>
					</div>
				</div>
				<div class = "row">
